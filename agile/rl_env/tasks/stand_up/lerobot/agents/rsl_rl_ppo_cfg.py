...
@configclass
class LeRobotStandUpPpoRunnerCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    num_steps_per_env = 24
    max_iterations = 100_000
    save_interval = 250
    experiment_name = "stand_up_lerobot_no_arms"
    run_name = "stand_up_lerobot_no_arms"
    wandb_project = "StandUp-LeRobot-NoArms"
